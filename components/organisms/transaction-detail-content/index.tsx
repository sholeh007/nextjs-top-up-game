          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
              ...
              <div className="purchase pt-30">
                ...
                <Row label="Price" value={42280500} isNumber />
                <Row label="Tax 10%" value={4228000} isNumber />
                <Row label="Total" value={55000600} isNumber styles />
              </div>
              <div className="payment pt-10 pb-10">
                ...
                <Row label="Bank Account Name" value="PT StoreUp ID" />
